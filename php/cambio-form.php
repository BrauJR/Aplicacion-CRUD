<div>
    ...
    <input type="hidden" name="email_hdn" value="<?php echo $registo_contacto["email"] ?>">
</div>
<div>
...
<div>
 ...
 <div class="adjuntar-archivo cambio">
    ...
    <input type="hidden" name="foto_hdn" value="<?php echo $registo_contacto["imagen"] ?>">
 </div>
 <div>
 ...
 <div>
    <input type="submit" name="enviar_btn" id="enviar-cambio" class="cambio" value="Cambiar">
 </div>